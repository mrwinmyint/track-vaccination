/****** Object:  Table [dbo].[VaccineType]    Script Date: 7/11/2020 9:18:39 PM ******/
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[VaccineType]') AND type in (N'U'))
BEGIN
